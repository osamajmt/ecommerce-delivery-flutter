...
import 'package:delivery_app/controller/order/available_controller.dart';
...
class AvailableOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(AvailableOrdersControllerImp());
    return Scaffold(
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      appBar: AppBar(
        title: Text("67".tr, style: Theme.of(context).textTheme.headlineLarge),
        centerTitle: true,
        elevation: 0,
      ),
      body: GetBuilder<AvailableOrdersControllerImp>(
        builder: (controller) {
         ...
         else if (controller.availableOrders.isEmpty && controller.statusRequest == StatusRequest.success) {
            return Center(
              child: Text(
                "70".tr,
